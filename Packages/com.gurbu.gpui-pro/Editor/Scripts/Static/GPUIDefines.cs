...
namespace GPUInstancerPro
{
    ...
    {
        public static readonly uint GPUI_PRO_BUILD_NO = 40;
        public static Version DEMO_UPDATE_VERSION = Version.Parse("0.12.0"); // The package version where the demo scenes were last updated and needs to be reimported.
