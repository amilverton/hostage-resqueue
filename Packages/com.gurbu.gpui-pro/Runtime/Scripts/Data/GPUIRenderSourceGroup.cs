    ...
    public class GPUIRenderSourceGroup : IGPUIDisposable
    {
        ...
        private void CreateShaderCommandParamsArray()
        {
            ...
            for (int i = 0; i < _shaderCommandParams.Count; i++)
            {
                ...
                _shaderCommandParamsArray[i * m + 0] = new Vector4(commandParams.instanceDataBufferShiftMultiplier, commandParams.transformOffset != identityMatrix ? 1f : 0f, optionalParams.x, optionalParams.y);
